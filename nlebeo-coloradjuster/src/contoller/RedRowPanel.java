...
public class RedRowPanel extends JPanel implements PropertyChangeListener {
    ...
    /** The TextField that allows the user to type input for the cooler value. */
    ...
    private static final int INCREASE_COLOR = 1;
    
    /** The decreasing steps for Red value. */
    private static final int DECREASE_COLOR = -1;
    ...
    private void addListeners() {
        ...
        myIncreaseButton.addActionListener(theEvent -> {
            myColor.adjustRed(INCREASE_COLOR);
            setIncreaseButton();
        });
        ...
        myDecreaseButton.addActionListener(theEvent -> {
            myColor.adjustRed(DECREASE_COLOR);
            setDecreaseButton();
        });
