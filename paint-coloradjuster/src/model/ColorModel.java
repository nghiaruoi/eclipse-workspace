...
public class ColorModel implements PropertyChangeEnabledMutableColor {
    ...
    /** Manager for Property Change Listener. */
    private final PropertyChangeSupport myPcs;
    
    //private final List<ProtertyChangeListener> myListeners;
    ...
    public void setRed(final int theRed) {
        ...
        myPcs.firePropertyChange(PROPERTY_COLOR, oldColor, this.getColor());
    }
...
//    public int getSpecificColor(final String theColorName) {
//        final Map<String, Integer> listMap = new HashMap<String, Integer>();
//        
//        listMap.put("Red", myRed);
//        listMap.put("Green", myGreen);
//        listMap.put("Blue", myBlue);
//        return listMap.get(theColorName);
//    }
